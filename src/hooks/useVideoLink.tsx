...
export const useVideoLink = () => {
    ...
    const [isLinkValid, setIsLinkValid] = useState<boolean | undefined>(undefined);
    const [error, setError] = useState('');
    const [isTouched, setIsTouched] = useState(false); 

    const validateLink = (link: string) => {
        return link.includes("youtube.com/watch")
    };
    ...
    return { isLinkValid, handleInputChange, videoLink, error };
}
