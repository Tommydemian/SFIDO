...
type NavigationProps = NativeStackScreenProps<DemoStackParams, 'DemoCreateMessageScreen'>

export const DemoCreateMessageScreen: React.FC<NavigationProps> = ({navigation}) => {
  const [isModalVisible, setIsModalVisible] = useState(false);

  const {videoId, text, modalSelectedImage, setModalSelectedImage, selectedImage, setSelectedImage} = useDemoMessageContext();
  ...
  return (
    ...
    <SafeAreaView style={styles.container}>
      ...
      <OnBoardingContainer>
        ...
        {/* Image modal */}
        <DemoImageModal selectedImage={selectedImage} 
        ...
        {
          modalSelectedImage && <View style={styles.modalSelectedImageContainer}>
          <Image 
        ...
        <SubmitButton onPress={() => navigation.navigate('DemoPreviewMessageScreen', {image: modalSelectedImage, text: text, videoId: videoId })}>
          <NunitoText type='bold' customStyles={styles.continueTextButton}>Continue</NunitoText></SubmitButton>
...

    {
      ...
      <CustomBottomSheet ref={bottomSheetRef}>
        <View style={styles.bottomSheetContentContainer}>
          ...
          <CustomIcon library='AntDesign' name="closecircleo" size={24} color={COLORS.blackSecondaryText} />
          </TouchableOpacity>
