import { StyleSheet, SafeAreaView, FlatList, Image, TouchableOpacity, View } from 'react-native'
...
export const InspirationScreen = () => {
  ...
  return (
    ...
    <Image source={forestImg} style={styles.image} />
      ...
      <QuoteCard customStyles={index === quoteIndex ? { backgroundColor: COLORS.whiteText, borderColor: COLORS.orangeWeb, borderWidth: 2 } : {}} text={item.text} author={item.author} />
      </View>
